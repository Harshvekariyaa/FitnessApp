...
class _WorkoutScreenState extends State<WorkoutScreen> {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: commonAppBar(
          ...
          actions: [
            IconButton(
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => WorkoutHistoryScreen())),
              icon: const Icon(Icons.date_range_outlined),
            ),
            IconButton(
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => InjuriesScreen())),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // ⚡ Quick Workouts
              Text("Quick Workouts", style: textStyle(AppColors.black, 20, AppColors.w600)),
              ...
              SizedBox(
                ...
                child: isLoading
                    ...
                    ? Center(child: Text("No quick workouts available", style: textStyle(AppColors.grey, 14, AppColors.normal)))
                    : ListView.separated(
                    ...
                    return SizedBox(
                      ...
                      child: _quickWorkoutCard(
                        ...
                        onTap: () => Navigator.push(context, MaterialPageRoute(
                          builder: (_) => DetailedWorkoutScreen(workout_id: w["workout_id"]),
                        )),
                      ),
                    );
                  },
              ...
              Row(
                children: [
                  Expanded(child: Text("All Workouts", style: textStyle(AppColors.black, 20, AppColors.w600))),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.close_rounded, size: 13, color: AppColors.energyRed),
                            const SizedBox(width: 4),
                            Text("Clear", style: TextStyle(color: AppColors.energyRed, fontSize: 12, fontWeight: FontWeight.w600)),
                          ],
                        ),
                      ),
                    ),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  prefixIcon: const Icon(Icons.search_rounded, color: AppColors.grey, size: 22),
              ...
              SizedBox(
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _goalChip(
                      label: f['label'], icon: f['icon'], isSelected: selected,
                      onTap: () { setState(() => _selectedGoal = f['key']); _searchFocusNode.unfocus(); },
                    );
                  },
                ),
              ),
                ...
                child: ListView.separated(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    return _difficultyChip(
                      label: f, isSelected: selected,
                      onTap: () { setState(() => _selectedDifficulty = f); _searchFocusNode.unfocus(); },
                    );
                  },
                ),
              ),
              ...
              if (_hasActiveFilters)
                Padding(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.grid_view_rounded, size: 14, color: AppColors.grey),
              ...
              isLoadingWorkout
                ...
                itemBuilder: (context, index) {
                  ...
                  return GestureDetector(
                    onTap: () => Navigator.push(context, MaterialPageRoute(
                      builder: (_) => DetailedWorkoutScreen(workout_id: workout["workout_id"]),
                    )),
                    child: _bodyFocusCard(
                      title:      workout['workout_name']           ?? '',
                      image:      workout['workout_image_url']      ?? '',
                      duration:   workout['workout_duration_minute']?.toString() ?? '',
  ...
  Widget _filterLabel(String label) => Text(
    label,
    style: TextStyle(color: Colors.grey.shade500, fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.9),
  );

  Widget _goalChip({required String label, required IconData icon, required bool isSelected, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(color: isSelected ? AppColors.primaryDark : Colors.grey.shade300, width: 1),
        ),
        child: Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            const SizedBox(width: 6),
            Text(label, style: TextStyle(color: isSelected ? Colors.white : AppColors.grey, fontSize: 13, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w500)),
          ],
        ),
      ),
    );
  ...
  Widget _difficultyChip({required String label, required bool isSelected, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: AnimatedContainer(
        duration: const Duration(milliseconds: 200),
        ...
        child: Row(
          ...
          children: [
            if (label != 'All') ...[
              Container(width: 8, height: 8, decoration: BoxDecoration(shape: BoxShape.circle, color: isSelected ? Colors.white : _difficultyColor(label))),
              const SizedBox(width: 6),
            ],
            Text(label, style: TextStyle(color: isSelected ? Colors.white : AppColors.grey, fontSize: 13, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w500)),
          ],
  ...
  Widget _buildAICard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: AppColors.primaryDark.withOpacity(0.28), blurRadius: 20, offset: const Offset(0, 8))],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.generating_tokens_outlined, color: AppColors.white, size: 22),
              ),
              const SizedBox(width: 12),
              Expanded(child: Text("AI Workout Plan", style: textStyle(AppColors.white, 18, AppColors.w600))),
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                decoration: BoxDecoration(color: AppColors.energyRed, borderRadius: BorderRadius.circular(20)),
                child: Text("NEW", style: textStyle(AppColors.white, 10, AppColors.w600)),
              ),
            ],
          ),
          const SizedBox(height: 12),
          Text(
            ...
            style: textStyle(AppColors.white.withOpacity(0.88), 13, AppColors.normal),
          ),
          const SizedBox(height: 16),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton.icon(
              onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => GenerateWorkoutScreen())),
              icon: Icon(Icons.auto_awesome_rounded, size: 17, color: AppColors.primaryDark),
              label: Text("Generate Workout", style: textStyle(AppColors.primaryDark, 14, AppColors.w600)),
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Icon(Icons.fitness_center_rounded, size: 40, color: Colors.grey.shade400),
            ),
            const SizedBox(height: 16),
            Text("No workouts found", style: textStyle(AppColors.black, 16, AppColors.w600)),
            const SizedBox(height: 6),
            Text("Try a different search or filter", style: textStyle(AppColors.grey, 13, AppColors.normal)),
  ...
  Widget _quickWorkoutCard({required String title, required String image, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        decoration: BoxDecoration(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              image.isNotEmpty
                  ? Image.network(image, fit: BoxFit.cover, errorBuilder: (_, __, ___) => Image.asset("assets/images/begginer.jpeg", fit: BoxFit.cover))
                  : Image.asset("assets/images/begginer.jpeg", fit: BoxFit.cover),
              Container(
                decoration: BoxDecoration(
              ...
              Positioned(
                ...
                child: Text(title, maxLines: 2, overflow: TextOverflow.ellipsis, style: textStyle(AppColors.white, 14, AppColors.w600)),
              ),
            ],
          ),
        ),
  ...
  Widget _bodyFocusCard({
    ...
    final firstGoal = goals.isNotEmpty ? (goals[0]['goal_name'] ?? '') as String : '';
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [Colors.black.withOpacity(0.82), Colors.black.withOpacity(0.15), Colors.transparent],
                  ),
                ),
              ),
            ),
              ...
              child: Row(
                ...
                children: [
                  if (firstGoal.isNotEmpty)
                    Flexible(
                      child: Container(
                        ...
                        decoration: BoxDecoration(color: _goalColor(firstGoal).withOpacity(0.88), borderRadius: BorderRadius.circular(20)),
                        child: Text(_goalDisplayName(firstGoal), overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w600)),
                      ),
                    )
                  else
                    const SizedBox(),
                  if (difficulty.isNotEmpty)
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 4),
                      decoration: BoxDecoration(color: _difficultyColor(difficulty).withOpacity(0.88), borderRadius: BorderRadius.circular(20)),
                      child: Text(difficulty, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w600)),
                    ),
                ],
              ),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (duration.isNotEmpty) ...[
                    ...
                    Row(
                      children: [
                        const Icon(Icons.timer_outlined, color: Colors.white60, size: 13),
                        const SizedBox(width: 4),
                        Text("$duration min", style: const TextStyle(color: Colors.white60, fontSize: 12)),
                      ],
                    ),
                  ],
                ],
